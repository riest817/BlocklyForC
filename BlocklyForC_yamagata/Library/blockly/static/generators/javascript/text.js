...
Blockly.JavaScript['text_char'] = function(block) {
  // Text value.
  var code = block.getTitleValue('TEXT');
  code = '\'' + code + '\'';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
...
Blockly.JavaScript['text_printf'] = function(block) {
  // Print statement.
  var TYPES = {
    INT: '%d',
    DOUBLE: '%f',
...
Blockly.JavaScript['text_scanf'] = function(block) {
  ...
  var argument0 = Blockly.JavaScript.valueToCode(block, 'TEXT',
      Blockly.JavaScript.ORDER_NONE) || '\'\'';
  return 'scanf("' + type + '", ' + '&' + argument0 + ');\n';
};

Blockly.JavaScript['text_printf2'] = function(block) {
  // Print statement.
  var argument0 = Blockly.JavaScript.valueToCode(block, 'TEXT',
      Blockly.JavaScript.ORDER_NONE) || '\'\'';
...
Blockly.JavaScript['text_puts'] = function(block) {
  // Print statement.
  var argument0 = Blockly.JavaScript.valueToCode(block, 'TEXT',
      Blockly.JavaScript.ORDER_NONE) || '\'\'';
...
Blockly.JavaScript['text_putchar'] = function(block) {
  // Print statement.
  var argument0 = Blockly.JavaScript.valueToCode(block, 'TEXT',
      Blockly.JavaScript.ORDER_NONE) || '\'\'';
...
Blockly.JavaScript['quiz_printf2'] = function(block) {
...
Blockly.JavaScript['quiz_printf2_pre'] = function(block) {
  // TODO: Assemble ' + language + ' into code variable.
  var code = 'printf(\"%d\\n\", arr[0]);\nprintf(\"%d\\n\", arr[1]);\nprintf(\"%d\\n\", arr[2]);\nprintf(\"%d\\n\", arr[3]);\nprintf(\"%d\\n\", arr[4]);\n';
  return code;
};

Blockly.JavaScript['quiz_printf_arr'] = function(block) {
  var code = 'printf(\"%d\\n\", arr[i]);\n';
  return code;
};

Blockly.JavaScript['quiz_printf_n'] = function(block) {
  var code = 'printf(\"%d\\n\", arr[n]);\n';
  return code;
};

Blockly.JavaScript['quiz_printf_i'] = function(block) {
  var code = 'printf(\"%d\\n\", i);\n';
  return code;
};

Blockly.JavaScript['quiz3_printf1'] = function(block) {
  var code = 'printf(\"%d : Good\\n\", arr[i]);\n';
  return code;
};

Blockly.JavaScript['quiz3_printf2'] = function(block) {
  var code = 'printf(\"%d : Bad\\n\", arr[i]);\n';
  return code;
};

Blockly.JavaScript['quiz_scanf_n'] = function(block) {
  var code = 'scanf(\"%d\", &n);\n';
  return code;
};

Blockly.JavaScript['quiz_scanf_arr'] = function(block) {
  var code = 'scanf(\"%d\", &arr[i]);\n';
  return code;
};

Blockly.JavaScript['quiz_process_a'] = function(block) {
  // TODO: Assemble ' + language + ' into code variable.
  var code = '//----------------\n' + '//  ProcessA\n' + '//----------------\n\n';
  return code;
};

Blockly.JavaScript['quiz_frame'] = function(block) {
  // TODO: Assemble ' + language + ' into code variable.
