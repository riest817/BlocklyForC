...
Blockly.Blocks['text_char'] = {
  ...
  init: function() {
    ...
    this.setOutput(true, 'String');
    //this.setTooltip(Blockly.Msg.TEXT_TEXT_TOOLTIP);
    this.setTooltip('入力された文字を返します。1文字だけ入力して下さい。');
  }
};
...
Blockly.Blocks['text_printf'] = {
  ...
  init: function() {
    ...
    this.setColour(160);
    this.appendValueInput('TEXT')
        //.appendTitle(Blockly.Msg.TEXT_PRINT_TITLE)
        .appendTitle("printf")
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('接続先のブロックを書式付きで出力します。');
  }
};
...
Blockly.Blocks['text_scanf'] = {
  ...
  init: function() {
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('入力された値を接続先のブロックに格納します。');
  }
};

Blockly.Blocks['text_printf2'] = {
  // Print statement.
  init: function() {
    //this.setHelpUrl(Blockly.Msg.TEXT_PRINT_HELPURL);
    this.setColour(160);
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('文字列を出力します。');
  }
};

Blockly.Blocks['text_puts'] = {
  // Print statement.
  init: function() {
    //this.setHelpUrl(Blockly.Msg.TEXT_PRINT_HELPURL);
    this.setColour(160);
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('文字列を出力し、最後に改行します。');
  }
};

Blockly.Blocks['text_putchar'] = {
  // Print statement.
  init: function() {
    //this.setHelpUrl(Blockly.Msg.TEXT_PRINT_HELPURL);
    this.setColour(160);
...
Blockly.Blocks['quiz_printf2'] = {
  init: function() {
    this.setColour(160);
    this.appendDummyInput()
        .appendTitle("printf(\"%d\",")
        .appendTitle(new Blockly.FieldDropdown([["arr[i]", "arr[i]"], ["arr[n]", "arr[n]"], ["arr[tmp]", "arr[tmp]"]]), "option")
        .appendTitle(");");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('');
...
Blockly.Blocks['quiz_printf3_for'] = {
  init: function() {
    this.setColour(160);
    this.appendDummyInput()
        .appendTitle("printf(\"%d\", arr[i]);")
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('');
  }
