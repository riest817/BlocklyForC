...
Blockly.JavaScript['quiz1_for'] = function(block) {
  var branch = Blockly.JavaScript.statementToCode(block, 'DO');
...
Blockly.JavaScript['quiz2_while'] = function(block) {
  var dropdown_option = block.getFieldValue('option');
  var branch = Blockly.JavaScript.statementToCode(block, 'DO');
...
Blockly.JavaScript['quiz3_for'] = function(block) {
  var branch = Blockly.JavaScript.statementToCode(block, 'DO');
...
Blockly.JavaScript['for_custom_before'] = function(block) {
  ...
  var value_input3 = Blockly.JavaScript.valueToCode(block, 'INPUT3', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['quiz_for'] = function(block) {
  var value_expression1 = Blockly.JavaScript.valueToCode(block, 'EXPRESSION1', Blockly.JavaScript.ORDER_ATOMIC);
  var value_expression2 = Blockly.JavaScript.valueToCode(block, 'EXPRESSION2', Blockly.JavaScript.ORDER_ATOMIC);
  var value_expression3 = Blockly.JavaScript.valueToCode(block, 'EXPRESSION3', Blockly.JavaScript.ORDER_ATOMIC);
