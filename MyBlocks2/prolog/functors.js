...
goog.provide('Blockly.Blocks.functors');

goog.require('Blockly.Blocks');

Blockly.Msg["FUNCTOR_HUE"] = 170;
/**
 * Common HSV hue for all blocks in this category.
 */
//Blockly.Blocks.functors.HUE = 170;

Blockly.Blocks['functor_definition'] = {
  /**
  ...
  init: function() {
    ...
    this.setColour(Blockly.Msg["FUNCTOR_HUE"]);
    ...
    this.setMutator(new Blockly.Mutator(['lists_create_join_item'])); // Todo: 専用の mutator
    this.setTooltip("アトムを定義します。");
  },
  /**
  ...
  updateShape_: function() {
    ...
    if (this.itemCount_ > 0) {
      ...
      if (!this.getInput('ADD0')) {
        var input = this.appendValueInput('ADD0');
      } 
...
//   init: function() {
//     this.appendDummyInput()
//         .appendField(Blockly.Msg.functor_definition_head)
//         .appendField(new Blockly.FieldTextInput(''), 'NAME')
//         .appendField('', 'PARAMS');
//     this.appendStatementInput('DELTA')
//         .appendField(Blockly.Msg.functor_definition_middle);  
//     this.setPreviousStatement(true);
//     this.setNextStatement(true);
