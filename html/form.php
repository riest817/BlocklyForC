...
//
$mail_sys = "s14t239@stmail.eng.kagawa-u.ac.jp";	// 管理者のメールアドレス
$from_name = "香川研究室 佐野";	// メール送信者の表示
$from_mail = "s14t239@stmail.eng.kagawa-u.ac.jp";	// メール送信者のメールアドレス（返信先）
$user_mail = "SANO Yuya";	// 利用者にメールを送る場合のメールアドレス項目
//---
$title = "お問い合わせフォーム";
...
$footer = "\n------------
香川研究室　佐野
http://ymir.eng.kagawa-u.ac.jp/~sano/
------------
";
//------------------------------------------------
