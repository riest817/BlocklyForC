...
/** ↓　言語切り替えを↓*/
Code.LANGUAGE_NAME['grammar'] = 'JavaScript表記';
...
//  console.log("languageMenu");
  var xmlDom  = Blockly.Xml.workspaceToDom(Code.workspace);
  var xmlText = Blockly.Xml.domToPrettyText(xmlDom);
  localStorage.setItem('BlocksStatus_JavaScript', xmlText); 
  */
  /*
...
document.write('<script src="js/msg/javascript/' + Code.LANG + '.js"></script>\n');
