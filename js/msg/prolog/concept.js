...
// 事実
Blockly.Msg.lists_group_head1 = "事実名: ";
Blockly.Msg.lists_group_head2 = "";
Blockly.Msg.lists_group_middle = "と";
Blockly.Msg.lists_group_end = "";
Blockly.Msg.fact_definition_head = "事実名";
Blockly.Msg.fact_definition_middle = "項";

// 規則
Blockly.Msg.rule_connection_head = "規則：";
Blockly.Msg.rule_connection_middle1 = "であれば";
Blockly.Msg.rule_connection_middle2 = "と";
Blockly.Msg.rule_connection_end = "である。";

// リスト
Blockly.Msg.lists_range_head = "リスト [";
Blockly.Msg.lists_range_middle = "|";
Blockly.Msg.lists_range_end = "]";
Blockly.Msg.lists_range_empty = "空リスト";

// 項
Blockly.Msg.term_name_head = "項名";
